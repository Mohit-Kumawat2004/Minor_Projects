...
class Student:
    def __init__(self,root):
       ...
       #1st image 
        img=Image.open(r"C:\Users\harsh\OneDrive\Pictures\ImagesHotel\mits.jpg")
        ...
        #background image
        img_4=Image.open(r"C:\Users\harsh\OneDrive\Pictures\ImagesHotel\university.png")
        ...
        img_5=Image.open(r"C:\Users\harsh\OneDrive\Pictures\ImagesHotel\3.jpg")
        ...
        #img 1
        img_7=Image.open(r"C:\Users\harsh\OneDrive\Pictures\ImagesHotel\5th.jpg")
        img_7=img_7.resize((798,200),Image.Resampling.LANCZOS)
    ...
    def add_data(self):
        if (self.var_enrollment.get()=="" or self.var_name.get()=="" or self.var_course.get()==""):
            ...
            try:
                conn=mysql.connector.connect(host="localhost",username="root",password="admin",database="student_management_system")
